...
def crear_boton_practica(texto_en_ingles, texto_en_espanol, id_unico):
    """
    Renderiza las oraciones emparejando colores por categorías gramaticales
    e inyecta un reproductor directo HTML5 sin comentarios de código obstructivos.
    """
    ...
    # Limpiar las etiquetas de color HTML para que el lector no pronuncie el código de colores
        ...
        <script>
            function playUSVoice() {{
                ...
                if ('speechSynthesis' in mainWin) {{
                    ...
                    // Forzar la selección del motor en inglés nativo del sistema
...
st.markdown("---")
# ==============================================================================
# SUBPARTE 5: SECCIÓN CORE I (OBJECTIVE Y REPORTES ESCRITOS CON COLORES COORDINADOS)
# ==============================================================================
...
# ==============================================================================
# SUBPARTE 6: SECCIÓN CORE II (SPOKEN ENGLISH, AUDITORÍAS Y SIGLAS CON COLORES)
# ==============================================================================
...
# ==============================================================================
# SUBPARTE 7: SIMULADOR DE FEEDBACK CASUAL CON SUPERVISOR Y CIERRE (COLORES)
# ==============================================================================
