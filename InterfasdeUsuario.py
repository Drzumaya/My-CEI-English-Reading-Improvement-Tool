...
# ==============================================================================
        ...
        if "Matriz" in entidad_activa_centro or "A.C." in entidad_activa_centro:
            st.markdown("---")
            st.markdown("""
            <div style='background-color: #1e4620; padding: 12px; border-radius: 6px; text-align: center; margin-bottom: 20px;'>
                <h3 style='color: white; margin: 0; font-size: 14px; font-weight: bold;'>
                    🏦 SIMULADOR COMPLETO DE LA CAJA DE AHORRO POPULAR Y CRÉDITO DE AVÍO
                </h3>
            </div>
            """, unsafe_allow_html=True)
            ...
            with c_caja2:
                ...
                st.markdown("<br>", unsafe_allow_html=True)
                st.table(tabla_amort_datos)
                st.caption("✓ <b>Evidencia de Materialidad:</b> Esta tabla de amortización sirve como soporte contable ante auditorías del SAT, acreditando que la mutua opera estrictamente con fines de fomento social sin especulación comercial.", unsafe_allow_html=True)
